...
isOpen,onClose,onSubmit,title, body,footer,actionLabel,disabled
  ...
  return (
    ...
    <>
    <div className="justify-center items-center flex overflow-x-hidden overflow-y-hidden fixed inset-0
    z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70">
